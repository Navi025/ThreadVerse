...
- Name: ThreadVerse Critical Path >> Landing page loads and shows repeating image transition
- Location: U:\Navnitya\Project\ThreadVerse\tests\critical-path.spec.js:10:7
...
Call log:
  - waiting for locator('thread-verse-app') to be visible
    57 × locator resolved to hidden <thread-verse-app></thread-verse-app>
